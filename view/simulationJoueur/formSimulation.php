<table>
    <form action="" method="POST">
        ...
        <tr>
            ...
            <td><input type="text" name="nomJoueurA" value="" size="20" /></td>
        </tr>

        <tr>
            <td><label>Classement Joueur A</label></td>
            <td><input type="number" name="ClassementJoueurA" value="" size="20" /></td>
        </tr>

        <tr>
            <td><label>Nom Joueur B</label></td>
            <td><input type="text" name="nomJoueurB" value="" size="20" /></td>
        </tr>
        <tr>
